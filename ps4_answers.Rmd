...
```{r}
mdp$feature_map_fun <- phi_fine
optimal_policy <- appr_policy_iteration(mdp,n_iter = 50, n_trans = 1e4, verbose = 1)
saveRDS(optimal_policy, file="results/optimal_policy_approx.rds")
```
